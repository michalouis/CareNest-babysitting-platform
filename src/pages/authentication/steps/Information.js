    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '2rem' }}>
            <Box sx={{ width: '80%', maxWidth: '1000px', textAlign: 'center' }}>
                <p style={{ fontSize: '1.5rem', marginBottom: '2rem' }}>Διαβάστε τις παρακάτω πληροφορίες για τα κριτήρια επιλεξιμότητας, τη διαδικασία που πρέπει να ακολουθήσετε και τις λειτουργίες της πλατφόρμας, ώστε να γνωρίζετε πώς να την χρησιμοποιήσετε σωστά πριν την εγγραφή σας.</p>
                {faqNannies.map((faq, index) => (
